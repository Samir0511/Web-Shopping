...
<?php
	...
	echo "<td colspan='4' bgcolor='gray'><font size='7px'> VIEW ORDER</font></td>";
	echo "<tr align='center'>";
	echo "<td bgcolor='gray' align='center'><font size='5px'>ID</td>";
	echo "<td bgcolor='gray' align='center'><font size='5px'>User_id</td>";
	echo "<td bgcolor='gray' align='center'><font size='5px'>Item_id</td>";
	echo "<td bgcolor='gray' align='center'><font size='5px'>Status</td>";
